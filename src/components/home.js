...
export default function Home(props) {
                ...
                resources.forEach(resKey => {
                    ...
                    if (demKey.job_level == demKey.job_level) {
                        resultData[demKey.demand_id] = {
                            ...
                            "mtach_skills": match_skills.toString(),
                            ...
                            "emp_pskill": resKey.primary_skill,
                            "emp_sskil": resKey.secondary_skill,
                            "demand_skill": demKey.primary_skill
    ...
    return (
        <div>
            <Dropdown>
                <span className="demand">Demand owner :: </span>
                <Dropdown.Toggle variant="primary">
                    {contextval.currentusername}
                </Dropdown.Toggle>
                <Dropdown.Menu>
                    <Dropdown.Item href="#" onClick={() => {
                        contextval.setcurrentuser('testuser1'); contextval.setcurrentusername('Rajkumar Ramasani');
                        setclosematch([])
                        setbestmatch([])
                    }}>
                        Rajkumar Ramasani
                    ...
                    <Dropdown.Item href="#" onClick={() => {
                        contextval.setcurrentuser('testuser2');

                        contextval.setcurrentusername(' Paul Prem Sagar')
                        setclosematch([])
                        setbestmatch([])
                    }}>
                        Paul Prem Sagar
                    ...
                    <Dropdown.Item href="#" onClick={() => {
                        contextval.setcurrentuser('testuser3');

                        contextval.setcurrentusername('Shweta Jain')
                        setclosematch([])
                        setbestmatch([])
                    }}>
                        Shweta Jain
            ...
            <div className="cards">
                ...
                <article className="card">
                    <div className="text">
                        <img height="30%" width="30%" src={Capability} alt="pic" />
                        <h3>Capability level Resource Data</h3>
                ...
                <article className="card">
                    <div className="text">
                        <img height="30%" width="30%" src={PartialCapability} alt="pic" />
                        <h3>Capability level skills availability</h3>
